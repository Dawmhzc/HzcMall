...
public interface GoodsMapper {
    ...
    @Insert("<script>" +
            ...
            "            (#{goods.goodsName},#{goods.goodsIntro},#{goods.goodsCategoryId},\n" +
            "            #{goods.goodsImg},#{goods.originalPrice},#{goods.sellingPrice},\n" +
            "            #{goods.stockNum},#{goods.createUser},#{goods.createTime})\n" +
            "        </foreach>"+
            "</script>")
    ...
    @Select("select * from goods where goods_name=#{goodsName} and goods_category_id=#{goodsCategoryId}")
    Goods selectByCategoryIdAndName(@Param("goodsName") String goodsName, @Param("goodsCategoryId") Integer goodsCategoryId);
